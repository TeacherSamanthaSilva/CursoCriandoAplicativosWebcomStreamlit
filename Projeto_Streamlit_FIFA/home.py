...
if "data" not in st.session_state:
    df_data = pd.read_csv("C:\\Users\\Samantha\\Documents\\GitHub\\CursoCriandoAplicativosWebcomStreamlit\\Projeto_Streamlit_FIFA\\datasets\\CLEAN_FIFA23_official_data.csv", index_col=0)
